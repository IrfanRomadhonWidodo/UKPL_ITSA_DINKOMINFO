    ...
    <div class="min-h-screen bg-[#E0F7FE] py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
                <!-- Contact Information -->
                <div
                    class="scroll-animate bg-gradient-to-br from-[#00ADE5] to-[#016DAE] rounded-2xl p-8 text-white shadow-xl relative overflow-hidden opacity-0 transform translate-y-8 transition-all duration-700 ease-out">
                    <div class="flex items-center mb-6">
                        <div
                            class="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center mr-4 transform transition-transform duration-300 hover:scale-110">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start transform transition-all duration-300 hover:translate-x-2">
                            <svg class="w-5 h-5 mr-4 flex-shrink-0 mt-1" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <span>Jl. Masjid No. 8, Sokanegara, Kec.<br>Purwokerto Timur, Kabupaten Banyumas,<br>Jawa
                                Tengah 53115</span>
                        </div>
                    </div>
                ...
                <!-- Feedback Form -->
                <div
                    class="scroll-animate bg-white rounded-2xl p-8 shadow-xl opacity-0 transform translate-y-8 transition-all duration-700 ease-out">
                    ...
                    @auth
                        <form action="{{ route('kontak.feedback') }}" method="POST" class="space-y-6">
                            @csrf
                            <div>
                                <label for="subjek" class="block text-sm font-medium text-gray-700 mb-2">Pilih
                                    Subjek</label>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-3" required>
                                    <label
                                        class="flex items-center p-3 border rounded-lg hover:bg-gray-50 cursor-pointer transform transition-all duration-300 hover:scale-105 hover:shadow-md">
                    ...
                    @else
                        <div class="text-center py-12">
                            <div
                                class="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4 transform transition-all duration-300 hover:scale-110">
            ...
            <!-- Location Section -->
            <div
                class="scroll-animate bg-white rounded-2xl shadow-xl overflow-hidden opacity-0 transform translate-y-8 transition-all duration-700 ease-out">
                <div class="p-8">
                    <p class="text-gray-600 mb-6">
                        Dinas Komunikasi dan Informatika Bidang Persandian dan Telekomunikasi Banyumas
                    </p>
                    <div
                        class="flex items-center text-gray-700 mb-6 transform transition-all duration-300 hover:translate-x-2">
                        ...
                        <span>Jl. Masjid No. 8, Sokanegara, Kec. Purwokerto Timur, Kabupaten Banyumas, Jawa Tengah
                            53115</span>
                    </div>
                </div>
                ...
                <div class="p-6 bg-gray-50 border-t">
                    <a href="https://maps.app.goo.gl/UmoxzjGgTkPZbHVJ9" target="_blank"
