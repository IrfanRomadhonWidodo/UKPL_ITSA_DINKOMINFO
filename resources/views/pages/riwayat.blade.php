<x-app-layout>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mb-6">
                        <div class="flex items-center space-x-3">
                            <div
                                class="w-10 h-10 bg-gradient-to-r from-[#00ADE5] to-[#016DAE] rounded-lg flex items-center justify-center">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 text-sm">Lihat status dan detail semua formulir yang telah Anda
                                    ajukan</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-2xl font-bold text-yellow-800">
                                        {{ $formulir->where('status', 'diproses')->count() }}</p>
                                </div>
                            ...
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-2xl font-bold text-red-800">
                                        {{ $formulir->where('status', 'revisi')->count() }}</p>
                                </div>
                            ...
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-2xl font-bold text-green-800">
                                        {{ $formulir->where('status', 'selesai')->count() }}</p>
                                </div>
                                        ...
                                        @foreach($formulir as $item)
                                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="flex items-center">
                                                        <div
                                                            class="w-10 h-10 bg-gradient-to-r from-[#00ADE5] to-[#016DAE] rounded-lg flex items-center justify-center mr-3">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    ...
                                                    <div class="text-sm text-gray-500">{{ $item->created_at->format('H:i') }}
                                                    </div>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    @php
    ...
    <!-- Edit Modal -->
    <div id="editModal"
        class="fixed inset-0 bg-gray-600 bg-opacity-50 backdrop-blur-sm hidden overflow-y-auto h-full w-full z-50">
