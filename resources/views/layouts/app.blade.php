...
<body class="bg-[#E0F7FE] ">
    <div class="min-h-screen">
        ...
        <div class="fixed bottom-8 right-8 z-50 group">
            ...
            <div
                class="absolute right-16 bottom-1/2 translate-y-1/2 bg-white text-gray-700 text-sm font-medium px-4 py-2 rounded-lg shadow-md opacity-0 group-hover:opacity-100 transition duration-300 whitespace-nowrap">
        ...
        <div id="loading-screen"
            class="fixed inset-0 bg-white z-[9999] flex items-center justify-center transition-opacity duration-700">
            <div class="relative w-32 h-32">
                ...
                <div
                    class="w-32 h-32 rounded-full border-4 border-t-[#06b6d4] border-r-transparent border-b-transparent border-l-transparent animate-spin">
                </div>
            </div>
        </div>
